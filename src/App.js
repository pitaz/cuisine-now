...
import { View, ScrollView, Text, ImageBackground, CheckBox } from 'react-native';
import backgroundImage from './assets/images/action-cook-cooking-2237189.jpg';
import { Input, Button, Section, FormSection } from './components/common';
  ...
  return (
    ...
    >
      <ScrollView style={contentStyles}>
        <Text style={fontStyle}>Create an account</Text>
        ...
        <Section sectionStyle={centralize}>
          <Text style={styles.loginMessageStyle}>Already have an account? </Text>
          <Button textStyle={styles.linkStyle}>Login</Button>
        </Section>
      </ScrollView>
    </ImageBackground>
  );
